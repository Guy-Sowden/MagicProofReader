...
let defultText = "this will not replace close secutny of the text."
...
export let ruleSet = 
    ...
    {"pattern":/^[,|.|]]/gi, "options":[] , "type": "error"},
    {"pattern":/\w\.\w/gi, "options":[] , "type": "error"},
    {"pattern":/[;|\.|\,|:]{2,}/gi, "options":[] , "type": "error"},
    {"pattern":/¡/gi, "options":[] , "type": "error"},
    {"pattern":/[0-9]S[0-9]/g, "options":[] , "type": "error"},
]
// rules to add
